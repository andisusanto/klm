    ...
    <div class="tp-banner">
      <ul style="display:none;">
        ...
        <li data-transition="fade" data-slotamount="7" data-masterspeed="700">
          <img src="images/bannerphoto/<?php echo $BannerPhoto->Photo;?>" alt="<?php echo $BannerPhoto->Title;?>" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" />
        </li>
        <?php
          }
        ?>
            ...
            <div class="blog-main">
              <div class="blog-images">
                <div class="view view-fifth">
                  ...
                  ?>
                  <img src="images/projectphoto/<?php echo $ProjectPhoto->Photo ?>" alt="" />
                  <?php } ?>
